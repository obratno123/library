...
- чат поддержки;
- отдельная страница аналитики с ключевыми метриками по пользователям, книгам, заказам, выручке, популярным книгам и жанрам;
...
analytics_dashboard/ # страница аналитики и дашборд магазина
...
### `analytics_dashboard`
Отвечает за аналитическую страницу магазина.

Реализованы:
- просмотр количества пользователей;
- просмотр количества книг;
- просмотр количества заказов;
- просмотр оплаченных заказов;
- отображение выручки и среднего чека;
- графики по заказам и статусам;
...
- `/chat/` — чат поддержки
- `/analytics/` — страница аналитики магазина (для пользователей с соответствующей ролью)
